...
var pontosJogador = 0;
var pontosMaquina = 0;
var contagemRodada = 1;
var quantidadeCartaJogador = cartas.length / 2;
var quantidadeCartaMaquina = cartas.length / 2;

atualizaPlacar();
//atualizaQuantidadeDeCartas();
atualizaRodada();
atualizaQuantidadeDeCartasDeCada();

function atualizaQuantidadeDeCartasDeCada() {
  var divQuantidadeCartasCadaUm = document.getElementById("quantidade-cartas-jogadores");
  var html = "<div id='quantidade-cartas-jogadores'>Cartas jogador " + quantidadeCartaJogador + " / " + quantidadeCartaMaquina + " Cartas máquina</div>";
  divQuantidadeCartasCadaUm.innerHTML = html;
};

function atualizaRodada() {
  var divRodada = document.getElementById("rodada");
  var html = "<div id='rodada'>Rodada " + contagemRodada + "</div>";
  divRodada.innerHTML = html;
};
...
function jogar() {
    ...
    if(contagemRodada % 2 != 0) {
    //se a jogada for em rodada impar jogador joga:
      ...
      if (cartaJogador.atributos[atributoSelecionado] > cartaMaquina.atributos[atributoSelecionado]) {
          ...
          pontosJogador++;
          quantidadeCartaJogador++;
          quantidadeCartaMaquina--;
    ...
    //se a jogada for em rodada par máquina joga:
      var divResultado = document.getElementById("resultado");
      var maiorAtributo = obterMaiorValor((Object.values(cartaMaquina.atributos)));
      var escolhaMaquina;
      var atributosDaMaquina = Object.keys(cartaMaquina.atributos);
      var valoresAtributosDaMaquina = Object.values(cartaMaquina.atributos);
      for (var i = 0; i < 3; i++) {
        if (maiorAtributo == valoresAtributosDaMaquina[i]) {
          escolhaMaquina = atributosDaMaquina[i];
        }
      }
      if (cartaJogador.atributos[escolhaMaquina] > cartaMaquina.atributos[escolhaMaquina]) {
          htmlResultado = '<p class="resultado-final">Venceu</p>';
          pontosJogador++;
          quantidadeCartaJogador++;
          quantidadeCartaMaquina--;
      } else if (cartaJogador.atributos[escolhaMaquina] < cartaMaquina.atributos[escolhaMaquina]) {
          htmlResultado = '<p class="resultado-final">Perdeu</p>';
          pontosMaquina++;
          quantidadeCartaMaquina++;
          quantidadeCartaJogador--;
    ...
    if (quantidadeCartaMaquina == 0 || quantidadeCartaJogador == 0) {
        ...
        htmlResultado = '<p class="resultado-final">O jogador venceu!</p>';
         ...
         htmlResultado = '<p class="resultado-final">O placar final foi empate.</p>';
